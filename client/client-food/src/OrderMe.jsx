...
export const OrderMe = () => {
  ...
  const max = [...oids];
  console.log(max);
  console.log("greates order number id", Math.max(...oids));
  ...
  const HandleSubmit = async (e) => {
    ...
    products.forEach((component) => {
      const Pname = component.props.children?.[0];
      const quantity = component.props.children?.[3];
      const unitPrice = component.props.children?.[5];
      const amount = component.props.children?.[6];
